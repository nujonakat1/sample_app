...
class UserTest < ActiveSupport::TestCase
  ...
  # ユーザー削除時に一緒にマイクロポストも削除されるかの（dependent: :destroyの）テスト
  ...
  test "should follow and unfollow a user" do
    ...
    archer  = users(:archer)
    # フォローしていないユーザーをfollowing?メソッドで確認
    assert_not michael.following?(archer)
    # followメソッドでそのユーザーをフォローできること
    michael.follow(archer)
    # フォロー中になったことをfollowing?メソッドで確認できること
    assert michael.following?(archer)
    # followersに対するテスト（following じゃないよ）
